...
#define GPH3PUD_REG			__REG(ELFIN_GPIO_BASE+GPH3PUD_OFFSET)
#define GPH3DRV_REG			__REG(ELFIN_GPIO_BASE+GPH3DRV_OFFSET)
...
#define GPH3DRV				(ELFIN_GPIO_BASE+GPH3DRV_OFFSET)
