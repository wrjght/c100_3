...
/*
 * No NOR on JUDKC100 board when MOVI  or NAND booting
 */
...
#define CFG_PROMPT		"JUDKC100 # "	/* Monitor Command Prompt	*/
...
/*
 * JUDKC100 board specific data
 */

#define CONFIG_IDENT_STRING	" for JUDKC100"
