...
/*
 * No NOR on HKDKC100 board when MOVI  or NAND booting
 */
#ifndef CONFIG_USE_NOR_BOOT
...
#define CONFIG_BOOTARGS     "root=/dev/mmcblk0p2 rw rootfstype=ext3 mem=384m init=/init  console=ttySAC0,115200 androidboot.console=s3c2410_serial0 rootdelay=1"
...
#define CFG_PROMPT		"HKDKC100 # "	/* Monitor Command Prompt	*/
...
/*
 * HKDKC100 board specific data
 */

#define CONFIG_IDENT_STRING	" for HKDKC100"
